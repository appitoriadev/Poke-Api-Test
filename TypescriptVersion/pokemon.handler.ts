...
export class PokemonHandler {
    ...
    assignPokemonData(pokemon: Pokemon, imgElement: HTMLImageElement, nameElement: HTMLElement, hpElement: HTMLElement, attackElement: HTMLElement, defenseElement: HTMLElement, typeElement: HTMLElement): void {
